...
<head>
    ...
    <title>Register - AI Learning Services</title>
    ...
    <div class="relative z-10 w-full max-w-md mx-4">
        <div class="glass-morphism rounded-3xl p-8 neon-border">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-400">Start your AI learning journey today</p>
            </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-400">
                    ...
                    <a href="{{ route('login') }}" class="text-ai-neon-blue hover:text-ai-neon-purple transition-colors font-semibold">
                        Sign in
                    </a>
                </p>
            </div>
