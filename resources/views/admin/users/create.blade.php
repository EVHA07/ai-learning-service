...
<head>
    ...
    <title>Create User - AI Learning Admin</title>
    ...
    <main class="container mx-auto px-6 pt-24 pb-12">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold mb-4">
                <span class="gradient-text">Create New User</span>
            </h1>
            <p class="text-gray-400 text-lg">Add new user to AI Learning platform</p>
        </div>
                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        >
                            ...
                            <option value="2">Guru (Teacher)</option>
                            <option value="3">Murid (Student)</option>
                        </select>
                        @error('role_id')
                            <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                        @enderror
